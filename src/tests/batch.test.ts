...
describe("Batch Entity", () => {
  ...
  it("should update a batch", async () => {
    ...
    const select = await AppDataSource.getRepository(Batch)
  ...
  it("should delete a group", async () => {
    ...
    await AppDataSource.manager.delete(Batch, { id: savedId });

    const salect = await AppDataSource.getRepository(Batch)
      .createQueryBuilder("batch")
