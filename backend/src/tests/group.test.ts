...
describe("Group Entity", () => {
  ...
  it("should update a group", async () => {
    ...
    const select = await AppDataSource.getRepository(Group)
  ...
  it("should delete a group", async () => {
    ...
    await AppDataSource.manager.delete(Group, { id: savedId });

    const salect = await AppDataSource.getRepository(Group)
      .createQueryBuilder("group")
